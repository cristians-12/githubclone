        ...
        <header className="bg-black w-full flex flex-col gap-5 p-5">
          <div className="flex justify-between">
            <div className="flex gap-3 items-center">
              <div
                onClick={() => {document.querySelector(".menu").classList.remove("hidden");}}
              ...
              <div>
                <h3 className="hover:bg-gray-800 rounded-md p-3">/{user.username}</h3>
              </div>
            </div>
          ...
          <div className="flex gap-5">
            <div className="flex justify-center items-center gap-3 hover:bg-gray-800 rounded-md p-3 cursor-pointer" onClick={()=>{
            ...
            <div className="flex justify-center items-center gap-3 hover:bg-gray-800 rounded-md p-3 cursor-pointer" onClick={()=>{
                document.querySelector(".Repositorios").classList.remove("hidden")
